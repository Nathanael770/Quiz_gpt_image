...
public class Image extends system.proxies.FileDocument
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("QuizImage.Image_false", mendixObject.getType())) {
			return quizimage.proxies.Image_false.initialize(context, mendixObject);
		}
		if (com.mendix.core.Core.isSubClassOf("QuizImage.Image_true", mendixObject.getType())) {
